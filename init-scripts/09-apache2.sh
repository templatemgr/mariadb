...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202309041412-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  apache2.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Monday, Sep 04, 2023 14:12 EDT
# @@File             :  apache2.sh
# @@Description      :
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/webapps/phpmyadmin"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/env/apache2.script.sh" ] && . "$CONF_DIR/env/apache2.script.sh" # Generated by my dockermgr script
[ -f "$CONF_DIR/env/apache2.sh" ] && . "$CONF_DIR/env/apache2.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  local blowfish_pass="$(__random_password 24))"
  ...
  # replace variables
  sed -i 's|REPLACE_BLOWFISH_SECRECT|'$blowfish_pass'|g' "/config/phpmyadmin/config.php"
  # __replace "" "" "$CONF_DIR/apache2.conf"
  # replace variables recursively
  __initialize_replace_variables "/config/phpmyadmin/config.php"
