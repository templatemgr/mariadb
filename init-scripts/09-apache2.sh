...
[ -f "/config/env/apache2.script.sh" ] && . "/config/env/apache2.script.sh" # Generated by my dockermgr script
[ -f "/config/env/apache2.sh" ] && . "/config/env/apache2.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
